...
<div class="w-11/12 m-auto md:px-6 py-4 flex flex-row items-center justify-between">
<div class="w-full flex justify-center flex-col md:w-2/5">
...
<div class="flex gap-2 w-full">
      ...
      <button class="p-2 bg-yellow-300 rounded-lg">
