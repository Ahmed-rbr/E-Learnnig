...
<nav class="w-full  md:flex-row flex-col  fixed mb-2 bg-indigo-500 z-10  text-white text-lg font-semibold m-auto md:px-6 p-4 flex items-center justify-between">
