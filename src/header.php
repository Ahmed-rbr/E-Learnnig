...
</ul><div class="flex gap-4">
<button class="hover:bg-yellow-300 hover:text-white transition duration-200 ease-out hover:cursor-pointer   text-base rounded-3xl bg-white text-black px-4 py-2">Sign in</button>
